...
namespace SAHB.GraphQLClient.Tests.QueryGenerator
{
    public class QueryGeneratorVariableTest
    {
        ...
        public void Test_Query_Generator_String_Variable()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields), new GraphQLQueryArgument("variableName", "value"));
        ...
        public void Test_Query_Generator_Two_String_Variable()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields), new GraphQLQueryArgument("variableName1", "value1"),
        ...
        public void Test_Query_Generator_String_Converted_Variable()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields), new GraphQLQueryArgument("variableName", JsonConvert.SerializeObject(new {arg1 = "value1", arg2 = "value2"})));
        ...
        public void Test_Variable_Complex_Dynamic_Type()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields),
        ...
        public void Test_Variable_Not_Set_Should_Throw()
        {
            ...
            {
                var query = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields));
            });
        }
        ...
        public void Test_QueryGenerator_Should_Throw_When_No_Argument_Is_Supplied_To_Required_Argument()
        {
            ...
            // Act / Assert
            Assert.Throws<GraphQLArgumentsRequiredException>(() => _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields)));
        }
        ...
        public void Test_Inline_Int_Argument_Explicit()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields), new GraphQLQueryArgument("variableName", 1));
        ...
        public void Test_Inline_String_Argument_Explicit()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields), new GraphQLQueryArgument("variableName", "test"));
        ...
        public void Test_Inline_DynamicType_Argument_Implicit_Not_Inlined()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields), new GraphQLQueryArgument("variableName", new {arg1 = "val1", arg2 = 2}));
        ...
        public void Test_One_Explicit_Not_Inlined_And_One_Implicit_Inlined()
        {
            ...
            // Act
            var actual = _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields), new GraphQLQueryArgument("variableName", "test"), new GraphQLQueryArgument("variableName1", "test1"));
        ...
        public void Test_Should_Throw_When_Multiple_Same_Variables_Has_Been_Defined()
        {
            ...
            // Act / Assert
            Assert.Throws<GraphQLDuplicateVariablesException>(() => _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields),
        ...
        public void Test_Should_Throw_When_Multiple_Same_Variables_Has_Been_Defined_Only_One_Variable_In_Exception()
        {
            ...
            // Act / Assert
            var exception = Assert.Throws<GraphQLDuplicateVariablesException>(() => _queryGenerator.GenerateQuery(new GraphQLOperation(GraphQLOperationType.Query, fields),
                new GraphQLQueryArgument("variableName", "test"), new GraphQLQueryArgument("variableName", "test")));
