...
namespace SAHB.GraphQL.Client.Tests.Issues
{
    public class Issue61
    {
        ...
        public void GraphQLQueryGeneratorFromFields_Should_Throw_When_No_Matching_Argument_Found()
        {
            ...
            {
                // Get the query
                var query = queryGenerator.GenerateQuery(fieldGenerator.GenerateOperation(typeof(SampleQuery), GraphQLOperationType.Query),
        ...
        public void GraphQLQueryGeneratorFromFields_Should_Throw_When_No_Matching_Argument_Found_And_Only_One_Of_2_Arguments_Found()
        {
            ...
            {
                // Get the query
                var query = queryGenerator.GenerateQuery(fieldGenerator.GenerateOperation(typeof(SampleQuery2), GraphQLOperationType.Query),
