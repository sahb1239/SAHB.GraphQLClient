...
namespace SAHB.GraphQLClient.Tests.FieldBuilder.GraphQLArguments
{
    public class NestedGraphQLArgumentsAttributes
    {
        ...
        public void Test_GraphQLSkipArgument_In_Fieds()
        {
            ...
            var fields = _fieldBuilder.GenerateSelectionSet(typeof(SkipQueryToTest1)).ToList<GraphQLField>();
        ...
        {
            // Get all fields for the type QueryToTest
            var fields = _fieldBuilder.GenerateSelectionSet(typeof(TakeQueryToTest1)).ToList<GraphQLField>();
        ...
        {
            // Get all fields for the type QueryToTest
            var fields = _fieldBuilder.GenerateSelectionSet(typeof(SkipTakeQueryToTest1)).ToList<GraphQLField>();
